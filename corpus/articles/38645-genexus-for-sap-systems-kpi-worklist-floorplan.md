---
title: "GeneXus For SAP Systems - KPI Worklist Floorplan"
source_id: 38645
source_url: https://wiki.genexus.com/commwiki/wiki?38645
genexus_version: "18"
---
...
This article describes how to apply it to a [Transaction object](https://wiki.genexus.com/commwiki/wiki?1908) or [Web Panel object](https://wiki.genexus.com/commwiki/wiki?6916) to obtain a page like the following:

`[imagen omitida: wiki id 55194]`
...
Look at the Patterns tab of the Country Transaction. If you have never applied the Fiori for Web pattern in your Knowledge Base before, read [HowTo: Apply the Fiori for Web pattern for the first time](https://wiki.genexus.com/commwiki/wiki?38862). Otherwise, by positioning on the Fiori for Web Pattern tab, check the Apply this pattern on save checkbox and select the offered link to choose a floorplan:

`[imagen omitida: wiki id 54852]`

Then, select the KPI Worklist option from the list given by GeneXus:

`[imagen omitida: wiki id 54985]`

[Learn how to apply the KPI Worklist floorplan to a Web Panel](https://wiki.genexus.com/commwiki/wiki?42011).
...
| --- |
| **Backlinks** |
| [Toc:GeneXus for SAP Systems](https://wiki.genexus.com/commwiki/wiki?33616) | [GeneXus For SAP Systems - List Report Floorplan](https://wiki.genexus.com/commwiki/wiki?38572) | [GeneXus For SAP Systems - Simple Worklist Floorplan](https://wiki.genexus.com/commwiki/wiki?38636) |
