---
title: "HowTo: Authenticate to Azure Active Directory using GAM (GeneXus 18 Upgrade 5 or prior)"
source_id: 55881
source_url: https://wiki.genexus.com/commwiki/wiki?55881
genexus_version: "18"
---

# HowTo: Authenticate to Azure Active Directory using GAM (GeneXus 18 Upgrade 5 or prior)
...
This tutorial explains how to authenticate your users with [Azure Active Directory](https://azure.microsoft.com/en-us/services/active-directory/) using GAM.
...
### [Configuration at the Azure portal](#Configuration+at+the+Azure+portal)
...
* Use a preset option for Azure AD. Follow the article [HowTo: Configure OAuth 2.0 authentication with Microsoft Entra ID](https://wiki.genexus.com/commwiki/wiki?54371) to learn how to use it.
...
* The login to Azure Active Directory may be done by entering the user credentials in your application, not in the Azure portal.  
