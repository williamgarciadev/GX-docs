---
title: "HowTo: Deploy Static Front end to Docker using MSBuild Tasks"
source_id: 51115
source_url: https://wiki.genexus.com/commwiki/wiki?51115
genexus_version: "18"
---

# HowTo: Deploy Static Front end to Docker using MSBuild Tasks

This article describes the steps to deploy a Static Front end application to Docker. If you want to do it using the Application Deployment tool inside GeneXus, see [HowTo: Deploy Frontend applications to Docker containers](https://wiki.genexus.com/commwiki/wiki?51104).
...
| [HowTo: Deploy Frontend applications to Docker containers](https://wiki.genexus.com/commwiki/wiki?51104) | [HowTo: Deploy Static Front end to Docker using MSBuild Tasks (GeneXus 18 Upgrade 6 or prior)](https://wiki.genexus.com/commwiki/wiki?58901) |
