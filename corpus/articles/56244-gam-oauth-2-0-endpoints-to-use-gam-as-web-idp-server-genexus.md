---
title: "GAM - OAuth 2.0 Endpoints to use GAM as Web IDP Server (GeneXus 18 Upgrade 6 or prior)"
source_id: 56244
source_url: https://wiki.genexus.com/commwiki/wiki?56244
genexus_version: "18"
---

# GAM - OAuth 2.0 Endpoints to use GAM as Web IDP Server (GeneXus 18 Upgrade 6 or prior)
...
**scope:** Scope of the user account you wish to access. It's required only when "&GAMApplication.ClientAuthenticationRequestMustIncludeUserScopes" it's True.  
