---
title: "Log settings with environment variables (GeneXus 18 upgrade 1)"
source_id: 53615
source_url: https://wiki.genexus.com/commwiki/wiki?53615
genexus_version: "18"
---

# Log settings with environment variables (GeneXus 18 upgrade 1)
...
| --- | --- | --- | --- |
| GX\_LOG\_LEVEL | Configures how many details should be added to the log. | * debug * all * info * warn * error | Java Generator (v18 U1) |
...
| GX\_LOG\_OUTPUT | Indicates where to send the result of the Log Level property. | * ConsoleAppender   + (Writes to SYSOUT) * RollingFile   + (Writes to File) | Java Generator (v18 U1) |
