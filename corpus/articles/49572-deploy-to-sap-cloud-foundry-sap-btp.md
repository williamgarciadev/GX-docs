---
title: "Deploy to SAP Cloud Foundry - SAP BTP"
source_id: 49572
source_url: https://wiki.genexus.com/commwiki/wiki?49572
genexus_version: "18"
---

# Deploy to SAP Cloud Foundry - SAP BTP
...
1. You must verify that the [Java platform support property](https://wiki.genexus.com/commwiki/wiki?48353) is set with "Jakarta" and the [JDK Directory (JAVA HOME) property](https://wiki.genexus.com/commwiki/wiki?52135) is configured with the path to a JDK 17 (or 21) directory and then rebuild all if necessary. The default version in SAP BTP when using the sap\_java\_buildpack\_jakarta is Java 17 (or 21) as documented at [Developing Java in the Cloud Foundry Environment](https://help.sap.com/docs/BTP/65de2977205c403bbc107264b8eccf4b/a3f90069d6cd41da82f34a6123d82ce6.html?q=java%20buildpack#supported-versions).
2. You must include the reference to include the JDBC driver file as explained in [Application Deployment tool](https://wiki.genexus.com/commwiki/wiki?32092) in the section Deployment of additional files and directories.  For example, in the file gxdproj you must add:  
   ...
   Next, you must copy the ngdbc-2.14.10.jar to the environment Web\lib directory.
...
Origin = Specifies the name of the identity provider to use when logging in. This value is optional and will depend on how the SAP BTP Identity Provider is configured. (e.g.:ldap)  
...
| --- |
| **Backlinks** |
| [API Endpoint property](https://wiki.genexus.com/commwiki/wiki?45792) | [Application Name property in SAP Cloud Foundry](https://wiki.genexus.com/commwiki/wiki?45796) | [Cloud Foundry CLI Directory property](https://wiki.genexus.com/commwiki/wiki?45791) |
| [Deploy to SAP Cloud Foundry - SAP BTP](https://wiki.genexus.com/commwiki/wiki?49572) | [Deploy to SAP Cloud Foundry - SAP BTP (GeneXus 18 Upgrade 13 or prior)](https://wiki.genexus.com/commwiki/wiki?61099) | [Deploy to SAP Cloud Foundry - SAP BTP (GeneXus 18 Upgrade 13 or prior)](https://wiki.genexus.com/commwiki/wiki?61099) | [Deploy to SAP Cloud Foundry - SAP BTP (GeneXus 18 Upgrade 3 or prior)](https://wiki.genexus.com/commwiki/wiki?54602) |
| [Deploy to SAP Cloud Foundry - SAP BTP (GeneXus 18 Upgrade 3 or prior)](https://wiki.genexus.com/commwiki/wiki?54602) | [Table of contents:GeneXus for SAP Systems](https://wiki.genexus.com/commwiki/wiki?33616) |
| [GeneXus for SAP Systems - FAQ](https://wiki.genexus.com/commwiki/wiki?33843) | [GeneXus for SAP Systems 18 Release Notes](https://wiki.genexus.com/commwiki/wiki?51078) | [GeneXus for SAP Systems Deployment](https://wiki.genexus.com/commwiki/wiki?34484) | [GeneXus SAP Systems Deployment to a Production Environment](https://wiki.genexus.com/commwiki/wiki?35466) |
| [HANA Instance name property](https://wiki.genexus.com/commwiki/wiki?45795) | [How to use SAP HANA Database on SAP Business Technology Platform](https://wiki.genexus.com/commwiki/wiki?47848) | [Offline scenario of the Java Generator](https://wiki.genexus.com/commwiki/wiki?52360) | [Organization name property](https://wiki.genexus.com/commwiki/wiki?45793) |
| [SAP Cloud Foundry Password property](https://wiki.genexus.com/commwiki/wiki?45814) | [SAP Cloud Foundry User property](https://wiki.genexus.com/commwiki/wiki?45813) |
