---
title: "Identity Provider Configuration for GAM Remote Authentication (GeneXus 18 Upgrade 13 or prior)"
source_id: 60954
source_url: https://wiki.genexus.com/commwiki/wiki?60954
genexus_version: "18"
---

# Identity Provider Configuration for GAM Remote Authentication (GeneXus 18 Upgrade 13 or prior)
...
The **Allow WEB authentication** check box that is under the section **Web (GAMRemote, IDP using SSO)** must be selected to enter the following information (\*):
