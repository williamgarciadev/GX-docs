---
title: "Rows class property"
source_id: 41096
source_url: https://wiki.genexus.com/commwiki/wiki?41096
genexus_version: "18"
---

# Rows class property

Class used to style the dashboard rows.
...
Defines the Theme class to be used to style the dashboard rows.
...
When you define a Class with a solid Border Style and 2px width, the final render is as follows:

`[imagen omitida: wiki id 41738]`
