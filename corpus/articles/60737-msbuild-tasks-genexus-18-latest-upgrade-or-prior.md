---
title: "MSBuild Tasks (GeneXus 18 latest upgrade or prior)"
source_id: 60737
source_url: https://wiki.genexus.com/commwiki/wiki?60737
genexus_version: "18"
---

# MSBuild Tasks (GeneXus 18 latest upgrade or prior)
...
*Object*: $(ObjectName) is the name of an [object](https://wiki.genexus.com/commwiki/com.gxwiki.wiki?1866,,) defined in the Knowledge Base to which the property will be assigned. **REQUIRED.**
...
### [CreateOfflineDatabase](#CreateOfflineDatabase)
...
### [ConvertExportFile](#ConvertExportFile)

Converts an XPZ file from previous versions to the [GeneXus 18](https://wiki.genexus.com/commwiki/wiki?51066) version format.

The task requires having a Knowledge Base (KB) open, since opening and converting an XPZ file accesses the KB to convert references to common objects (e.g., the 'Messages' SDT).

**Note**: This task is available starting from [GeneXus 18 Upgrade 14](https://wiki.genexus.com/commwiki/com.gxwiki.wiki?59631,,) or higher, but it is not available in [GeneXus Next Desktop](https://wiki.genexus.com/commwiki/com.gxwiki.wiki?37055,,). GeneXus Next Desktop supports importing XPZ files in GeneXus 18 format. If your XPZ file is from an older version, you must first convert it to [GeneXus 18](https://wiki.genexus.com/commwiki/wiki?51066).

#### [Syntax](#Syntax)

```
<ConvertExporFile File="$(XPZFileName)" OutputFile="$(ConvertedXPZFileName)"/>
```

#### [Options](#Options)

*File*: consists of the XPZ file name to be converted.

*OutputFile*: consists of the XPZ file name converted. This is an optional parameter.
