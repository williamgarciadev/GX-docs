---
title: "Apple Maps API property"
source_id: 39267
source_url: https://wiki.genexus.com/commwiki/wiki?39267
genexus_version: "18"
---
...
Make sure to set the [iOS Deployment Target property](https://wiki.genexus.com/commwiki/wiki?47294) to 16 in order to compile with the [Apple Generator](https://wiki.genexus.com/commwiki/wiki?14917) and Google Maps.
...
| --- |
| **Backlinks** |
| [Apple Maps API Key property](https://wiki.genexus.com/commwiki/wiki?39268) | [Apple Maps API property (GeneXus 18 Upgrade 12)](https://wiki.genexus.com/commwiki/wiki?60791) | [Apple Maps API property (GeneXus 18 Upgrade 13)](https://wiki.genexus.com/commwiki/wiki?60792) |
| [HowTo: Get a Google Maps API Key for Apple](https://wiki.genexus.com/commwiki/wiki?39319) |
