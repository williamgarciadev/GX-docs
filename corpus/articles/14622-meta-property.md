...
title: "Meta Property"
source_id: 14622
source_url: https://wiki.genexus.com/commwiki/wiki?14622
genexus_version: "18"
---

# Meta Property

Allows to manage [meta elements](http://en.wikipedia.org/wiki/Meta_element) present in the generated HTML document header for the object, using the "name" attribute for them.
...
### [This line in the GeneXus object](#This+line+in+the+GeneXus+object)

```
Form.Meta.AddItem('NewTag', 'NewValue')
```

will generate the following line in the generated HTML document header

```
<meta name="NewTag" content="NewValue">
```

### [Scope](#Scope)

**Objects:** [Transactions](https://wiki.genexus.com/commwiki/com.gxwiki.wiki?1908,,), [Web Panels](https://wiki.genexus.com/commwiki/wiki?6916)  
