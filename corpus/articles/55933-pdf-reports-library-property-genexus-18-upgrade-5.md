---
title: "PDF Reports Library property (GeneXus 18 Upgrade 5)"
source_id: 55933
source_url: https://wiki.genexus.com/commwiki/wiki?55933
genexus_version: "18"
---

# PDF Reports Library property (GeneXus 18 Upgrade 5)
...
In addition, it is important to note that PDFBox is a low-level library that is not designed to create [complex layouts](https://pdfbox.apache.org/2.0/faq.html), such as multi-level lists, tables, inline or internal styles. If a more sophisticated rendering of HTML content in PDF reports is required, it is recommended to consider using iText 8, which offers enhanced rendering capabilities for more advanced presentation in the generated PDF documents.
