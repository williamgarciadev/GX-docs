---
title: "GXflow Software Requirements (GeneXus 18 Upgrade 4 or prior)"
source_id: 55579
source_url: https://wiki.genexus.com/commwiki/wiki?55579
genexus_version: "18"
---

# GXflow Software Requirements (GeneXus 18 Upgrade 4 or prior)
...
(1) - Internet Information Server 7 or higher when using [Azure](https://wiki.genexus.com/commwiki/wiki?15052,,).  
...
| --- | --- |
| **DBMS** | **Version** |
| \* DB2 Universal Database   \* DB2 UDB for iSeries  \* Informix  \* MySQL  \* Oracle  \* PostgreSQL  \* SQL Server  \* SAP Hana | \* [8.0 or higher](https://wiki.genexus.com/commwiki/wiki?10479)  \* V5R2 or higher  \* [11 or higher](https://wiki.genexus.com/commwiki/wiki?9399)  \* [5.0.3 or higher](https://wiki.genexus.com/commwiki/wiki?9420)  \* [9.0 or higher](https://wiki.genexus.com/commwiki/wiki?9112)  \* [8.3 or higher](https://wiki.genexus.com/commwiki/wiki?9419)  \* [2012 or higher](https://wiki.genexus.com/commwiki/wiki?9114)  \* [1.0 or higher](https://wiki.genexus.com/commwiki/wiki?47895) |
