---
title: "HowTo: My first GeneXus Java Application"
source_id: 45875
source_url: https://wiki.genexus.com/commwiki/wiki?45875
genexus_version: "18"
---

# HowTo: My first GeneXus Java Application

To build your GeneXus application in Java, you can choose to have JDK version 17 or higher installed and use Spring Boot or require the following:
...
* Check the Steps to make a Build of your KB with [Spring Boot](https://wiki.genexus.com/commwiki/wiki?55782).
* Be sure to configure the [Tomcat path property](https://wiki.genexus.com/commwiki/wiki?48354) and [Tomcat version property](https://wiki.genexus.com/commwiki/wiki?48352). Also make sure that your Tomcat is running.  
...
| --- |
| **Backlinks** |
| [HowTo: My first GeneXus Java Application (GeneXus 18 Upgrade 5 or prior)](https://wiki.genexus.com/commwiki/wiki?55769) | [Toc:Java Applications Development](https://wiki.genexus.com/commwiki/wiki?52358) | [Servlet directory property](https://wiki.genexus.com/commwiki/wiki?9122) |
