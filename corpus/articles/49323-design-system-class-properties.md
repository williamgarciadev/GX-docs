---
title: "Design System Class Properties"
source_id: 49323
source_url: https://wiki.genexus.com/commwiki/wiki?49323
genexus_version: "18"
---

# Design System Class Properties
...
These properties can be set using the [Properties Editor](https://wiki.genexus.com/commwiki/wiki?3160) as detailed in [HowTo: Configure Design System Class Properties](https://wiki.genexus.com/commwiki/wiki?49494). You can also write them following the syntax below.
...
If you want the text of the attribute and the text of the tag to match in all but a few characteristics, you could use the [Include style rule](https://wiki.genexus.com/commwiki/wiki?49353):
...
| --- |
| **Backlinks** |
| [Design System Class](https://wiki.genexus.com/commwiki/wiki?49309) | [Design System Class Properties (GeneXus 18 Upgrade 4 or prior)](https://wiki.genexus.com/commwiki/wiki?55682) | [Design System Class Properties List (GeneXus 18 Upgrade 4 or prior)](https://wiki.genexus.com/commwiki/wiki?55680) |
| [Design System Tokens](https://wiki.genexus.com/commwiki/wiki?47378) | [Toc:Design Systems](https://wiki.genexus.com/commwiki/wiki?40108) | [Filter by UI property](https://wiki.genexus.com/commwiki/wiki?55701) | [HowTo: Configure Design System Class Properties](https://wiki.genexus.com/commwiki/wiki?49494) |
