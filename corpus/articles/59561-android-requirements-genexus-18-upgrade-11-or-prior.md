---
title: "Android Requirements (GeneXus 18 Upgrade 11 or prior)"
source_id: 59561
source_url: https://wiki.genexus.com/commwiki/wiki?59561
genexus_version: "18"
---

# Android Requirements (GeneXus 18 Upgrade 11 or prior)
...
| Android SDK Platform-Tools | 34.0.4 or higher | - |
| Android SDK Build-tools | 34.0.0 exactly | - |
| Android Emulator | 32.1.15 or higher | - |
| Android 14(API 34) | Any | - |
| - SDK Platform | 34.0.4 or higher | - |
| - Google APIs Intel x86 Atom System Image API 34 | Any | If you have an Intel-based computer, use the **Intel x86** System Image. Otherwise, use the **ARM EABI v7a** System Image.  If there are any AVD already created with the previous requirement (*Intel x86 Atom System Image*), they will not be re-created. You may consider deleting it from the AVD Manager and re-running the app from GeneXus to create a new one. |

| **GeneXus 18 Upgrade 12 or higher users.** | | |
| --- | --- | --- |
| **Component** | **Required Version** | Comments |
...
* The generated Android application works on devices with API 21 (Android 5.0) or higher.
