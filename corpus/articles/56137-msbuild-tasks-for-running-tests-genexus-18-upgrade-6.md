---
title: "MSBuild Tasks for Running Tests (GeneXus 18 Upgrade 6)"
source_id: 56137
source_url: https://wiki.genexus.com/commwiki/wiki?56137
genexus_version: "18"
---

# MSBuild Tasks for Running Tests (GeneXus 18 Upgrade 6)
...
This task allows running all the tests by their type in a specific [Knowledge Base](https://wiki.genexus.com/commwiki/wiki?1836) or listed by their names using the TestObjects parameter.

Type: *{All, Unit, Web, UI, SD, Rest}*  
Specifies the type of test to run. Set:  
All: to run all enabled Unit tests first, then enabled web UI tests, and at last, all enabled SD UI tests. **Default value if TestObjects is not set.**  
