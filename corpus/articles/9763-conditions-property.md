...
source_id: 9763
source_url: https://wiki.genexus.com/commwiki/wiki?9763
genexus_version: "18"
---

# Conditions property

Defines filter(s) to be taken into account when navigating records that will be loaded in the Grid / Grid Free Style / Tabular Grid.
...
**Note**:  
This property applies to the individual control for which it is defined. It must not be confused with the *Conditions tab* of the GeneXus object (whose aim is to apply filters to the whole object: form, all the Grids, etc.).
...
| --- |
| **Backlinks** |
| [Conditions property (GeneXus 18 Upgrade 5 or prior)](https://wiki.genexus.com/commwiki/wiki?55966) | [Free Style Grid Properties](https://wiki.genexus.com/commwiki/wiki?9760) | [HowTo: In-app search in Native Mobile applications](https://wiki.genexus.com/commwiki/wiki?31862) |
| [Orders and Filters in Grids of Panels](https://wiki.genexus.com/commwiki/wiki?24805) |
