---
title: "GeneXus for SAP Systems First Build and Run (GeneXus 18 Upgrade 3 or prior)"
source_id: 54669
source_url: https://wiki.genexus.com/commwiki/wiki?54669
genexus_version: "18"
---

# GeneXus for SAP Systems First Build and Run (GeneXus 18 Upgrade 3 or prior)
...
To set the necessary information to connect with the Database and the web server, you must select the [Preferences](https://wiki.genexus.com/commwiki/wiki?7109) tab or press F5. Go to the Preferences tab. There you can see that the KB has only one [Environment](https://wiki.genexus.com/commwiki/wiki?7115) (it could have many but the KB was recently created with one Environment).
...
**Note**: In this guide, the environment was created with Microsoft SQLServer as the Database to prototype the application. A way of building applications that use [SAP HANA Database](https://wiki.genexus.com/commwiki/wiki?31713) is through the Cloud platform available from SAP, called SAP Business Technology Platform. To know all the details about how to create the Database in SAP Business Technology Platform and how to obtain the connection data to be used in GeneXus see: [How to use SAP HANA Database on SAP Business Technology Platform](https://wiki.genexus.com/commwiki/wiki?47848).
...
Afterward, depending on the following:
...
## [Error in the first table creation when you use SAP HANA Database](#Error+in+the+first+table+creation+when+you+use+SAP+HANA+Database)
