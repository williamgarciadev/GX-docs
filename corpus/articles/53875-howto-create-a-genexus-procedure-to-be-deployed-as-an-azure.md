---
title: "HowTo: Create a GeneXus Procedure to be deployed as an Azure or AWS Function (GeneXus 18 Upgrade 2)"
source_id: 53875
source_url: https://wiki.genexus.com/commwiki/wiki?53875
genexus_version: "18"
---

# HowTo: Create a GeneXus Procedure to be deployed as an Azure or AWS Function (GeneXus 18 Upgrade 2)

Some [Azure functions](https://wiki.genexus.com/commwiki/wiki?47430)  or Lambda Functions (other than the Http-triggered functions) may require parameters to be executed.  
...
* This is valid for functions whose trigger type is Service Bus, Queue, and Timer.
* The GeneXus Procedures have to be main ([Call protocol](https://wiki.genexus.com/commwiki/wiki?7947) = Internal).
...
The header of EventMessage allows getting from the Azure function or AWS Lambda all the information of the event (such as its ID).  
...
&myQueueItem = format(!"*Message Info*--> '%1'. *Custom Properties*--> %2.",&MessageInfo,&Data)
```

## [Deploy](#Deploy)

To deploy the Procedure as a function, use the deployment tool. See [HowTo: Deploy as Azure Functions](https://wiki.genexus.com/commwiki/wiki?49351) or Deploy to AWS Lambda.
...
**Azure Error Handling considerations**
