---
title: "GeneXus 18 hardware and software requirements (GeneXus 18 Upgrade 2 or prior)"
source_id: 54300
source_url: https://wiki.genexus.com/commwiki/wiki?54300
genexus_version: "18"
---

# GeneXus 18 hardware and software requirements (GeneXus 18 Upgrade 2 or prior)
...
| **Java** (1) | \* Oracle JDK or Open JDK 1.8 to Open JDK 17(2)  \* Servlet API implementation file for Web environments (for example servlet-api.jar file, 3.0 or higher) |
...
(2) - JDK 11 to JDK 17 is recommended to improve compilation performance.
...
| **Java** | \* Oracle JRE or Open JRE 1.8 to Open JRE 17  \* JAVA EE or JAKARTA EE Server with Servlet 3.0 to 5.0 specification(3)  \* DBMS JDBC Driver (4) |
| **Native Mobile** | \* [Apple Requirements](https://wiki.genexus.com/commwiki/wiki?19478)  \* [Android Requirements](https://wiki.genexus.com/commwiki/wiki?14449) |
| **Angular** | \* [Angular requirements](https://wiki.genexus.com/commwiki/wiki?42541) |
