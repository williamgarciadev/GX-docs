---
title: "Design Import option (GeneXus 18 latest upgrade or prior)"
source_id: 59501
source_url: https://wiki.genexus.com/commwiki/wiki?59501
genexus_version: "18"
---

# Design Import option (GeneXus 18 latest upgrade or prior)

The **Design Import** option allows you to create [GeneXus objects](https://wiki.genexus.com/commwiki/com.gxwiki.wiki?1866,,) from a user interface design made with a designer tool (e.g. [Sketch design toolkit](https://www.sketch.com/) or [Figma design toolkit](https://www.figma.com)). In order to achieve a good result, the designer must follow a set of [designer rules](https://wiki.genexus.com/commwiki/wiki?46871).
...
**NOTE:** Every [Structured Data Type object](https://wiki.genexus.com/commwiki/wiki?10021) and [Data Provider object](https://wiki.genexus.com/commwiki/wiki?5270) will be created under a TestData folder in your Knowledge Base.
