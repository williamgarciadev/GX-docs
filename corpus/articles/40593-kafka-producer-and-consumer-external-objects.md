---
title: "Kafka Producer and Consumer External Objects"
source_id: 40593
source_url: https://wiki.genexus.com/commwiki/wiki?40593
genexus_version: "18"
---
...
* Open a KB with [GeneXus 18 Upgrade 13](https://wiki.genexus.com/commwiki/com.gxwiki.wiki?59630,,).
* Download [Kafka API Jars](https://wiki.genexus.com/commwiki/com.gxwiki.wiki?40594,,) for Java, [Kafka API Dlls](https://wiki.genexus.com/commwiki/com.gxwiki.wiki?40595,,) for .NET Framework. In the .NET generator, there's no need to download DLLs manually, since the object references a NuGet package that is automatically restored during the application build process.
  + Unzip/copy them to the Environment directory. In the case of Java, add them to the classpath too.
* Import [Kafka API External Object and Sample code (GeneXus 18 Upgrade 13)](https://wiki.genexus.com/commwiki/com.gxwiki.wiki?59995,,)
...
| --- |
| **Backlinks** |
| [Kafka Producer and Consumer External Objects (GeneXus 18 Upgrade 11 or prior)](https://wiki.genexus.com/commwiki/wiki?59989) | [Kafka Producer and Consumer External Objects (GeneXus 18 Upgrade 12)](https://wiki.genexus.com/commwiki/wiki?59996) |
|
