...
source_id: 32092
source_url: https://wiki.genexus.com/commwiki/wiki?32092
genexus_version: "18"
---
...
When the [Enable Integrated Security property](https://wiki.genexus.com/commwiki/wiki?14706) is set to TRUE, the [Include GAM Backoffice property](https://wiki.genexus.com/commwiki/wiki?44996) will be shown. If the Include GAM Backend property is set to TRUE, the GAM Backend files will be included in the package. Otherwise, they will not be included.
...
* Generic Servlets 6.0 (i.e. Tomcat 10.1)
* JBOSS (Enterprise Java Beans)
* Tomcat 8.x
* Tomcat 10.0 (it adds support to [URL Rewrite](https://wiki.genexus.com/commwiki/wiki?46523) rules)
* Tomcat 10.1
* WebSphere (Enterprise Java Beans)

**Notes:**

* Generic Servlets 6.0 uses JDK 11 or higher.
...
* [Deploy Application Targets](https://wiki.genexus.com/commwiki/wiki?42079)
  + [HowTo: Deployment of a Command Line Procedure in Java](https://wiki.genexus.com/commwiki/wiki?55200)
* Deploy to PaaS
...
* Deploy Serverless
  ...
  + Serverless Service Backend
    ...
    - Azure Serveless
      ...
      * [HowTo: Use MSBuild tasks for Azure Functions deployment](https://wiki.genexus.com/commwiki/wiki?59965)
...
* Containerization
  ...
  + [Deploy to a Kubernetes cluster](https://wiki.genexus.com/commwiki/wiki?45416)
    - [Deploy Java application to Docker and Kubernetes using Redis](https://wiki.genexus.com/commwiki/wiki?57627)
...
* Application Configuration
  + [Generate OpenAPI Interface property at Deploy Target Options](https://wiki.genexus.com/commwiki/wiki?57978)
...
* Package Sources
  ...
  + [Packaging .NET sources](https://wiki.genexus.com/commwiki/wiki?54683)
    - [Building Azure Serverless from sources](https://wiki.genexus.com/commwiki/wiki?55350)
    - [Building Azure functions from sources](https://wiki.genexus.com/commwiki/wiki?59963)
