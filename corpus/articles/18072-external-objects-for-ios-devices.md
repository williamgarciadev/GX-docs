---
title: "External Objects for iOS Devices"
source_id: 18072
source_url: https://wiki.genexus.com/commwiki/wiki?18072
genexus_version: "18"
---

# External Objects for iOS Devices
...
```
// Imports typically required in the extension:
import GXCoreBL
import GXCoreUI
...
fileprivate class ToastMessage {
    static func showToast(message: String, gxModel: GXModel? = nil, uiContext: GXUserInterfaceContext? = nil) {
        ...
        // 1) Resolve a controller
        let controller: UIViewController? = {
            if let c = uiContext?.userInterfaceController {
                return c
            }
            if let gxModel = gxModel {
                return GXExecutionEnvironmentHelper
                    .allConnectedWindows(for: gxModel)
                    .compactMapFirst { $0.rootViewController }
            }
            return GXExecutionEnvironmentHelper
                .allConnectedWindows
                .compactMapFirst { $0.rootViewController }
        ...
        // 2) Build and show a simple toast on controller.view
...
```
GXExecutionEnvironmentHelper.allConnectedWindows
```

API to resolve the root view controller and display a toast message. It is consistent with the implementation in the [GeneXus Extension Library Sample](https://github.com/genexuslabs/SDExtensionsSample/tree/master/SampleLibrary/iOS).
...
| --- |
| **Backlinks** |
| [Background Modes property](https://wiki.genexus.com/commwiki/wiki?35408) | [External Objects for iOS Devices (GeneXus 18 Upgrade 10)](https://wiki.genexus.com/commwiki/wiki?60965) | [External Objects for Native Mobile Applications](https://wiki.genexus.com/commwiki/wiki?17880) |
...
| [HowTo: create an External Object which triggers GeneXus events in iOS](https://wiki.genexus.com/commwiki/wiki?26936) | [HowTo: Migrate an External Object for iOS from Evolution 3 to GeneXus 15](https://wiki.genexus.com/commwiki/wiki?33805) | [Table of contents:Native Mobile Applications Development](https://wiki.genexus.com/commwiki/wiki?24799) |
