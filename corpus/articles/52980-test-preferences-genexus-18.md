---
title: "Test Preferences (GeneXus 18)"
source_id: 52980
source_url: https://wiki.genexus.com/commwiki/wiki?52980
genexus_version: "18"
---

# Test Preferences (GeneXus 18)
...
`[imagen omitida: wiki id 49602]`

### [KB version general testing options](#KB+version+general+testing+options)

#### [**Enable mocking: Boolean**](#Enable+mocking%3A+Boolean)
